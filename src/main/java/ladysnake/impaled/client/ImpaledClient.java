...
public class ImpaledClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        for (ImpaledTridentItem item : ImpaledItems.ALL_TRIDENTS) {
            ...
            EntityRendererRegistry.INSTANCE.register(item.getEntityType(), ctx -> new ImpaledTridentEntityRenderer(ctx, texture, modelLayer));
        ...
        EntityRendererRegistry.INSTANCE.register(ImpaledEntityTypes.GUARDIAN_TRIDENT, ctx -> new ImpaledTridentEntityRenderer(ctx, new Identifier(Impaled.MODID, "textures/entity/guardian_trident.png"), EntityModelLayers.TRIDENT));
    }
}
