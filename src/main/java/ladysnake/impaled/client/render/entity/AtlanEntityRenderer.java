...
public class AtlanEntityRenderer extends EntityRenderer<ImpaledTridentEntity> {
    private final AtlanEntityModel model;
    private final Identifier texture;

    public AtlanEntityRenderer(EntityRendererFactory.Context context, Identifier texture) {
        super(context);
        this.model = new AtlanEntityModel(context.getPart(ImpaledClient.ATLAN));
