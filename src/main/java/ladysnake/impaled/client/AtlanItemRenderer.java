...
public class AtlanItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer, SimpleSynchronousResourceReloadListener {
    private final Identifier id;
    private final Identifier tridentId;
    private final Identifier texture;
    private ItemRenderer itemRenderer;
    private AtlanEntityModel tridentModel;
    private BakedModel inventoryTridentModel;

    public AtlanItemRenderer(Identifier tridentId, Identifier texture) {
